import { Bell, Heart, Loader2, LogOut, Menu, Settings, User, X, Check, CheckCheck, Gift, FileText, Users } from 'lucide-react';
              ...
              <>
                ...
                <div className="relative" ref={notificationRef}>
                  <button
                    ...
                    className="relative p-2 text-gray-600 hover:text-primary-600 transition-colors notification-bell"
                          ...
                          groupedNotifications.map(([groupName, groupNotifications]) => (
                            <div key={groupName} className="border-b border-gray-100 last:border-b-0">
                              ...
                              {groupNotifications.map((notification) => (
                                <div
                                  key={notification.id}
                                  className={`px-5 py-4 border-b border-gray-50 last:border-b-0 transition-colors hover:bg-gray-50 ${
