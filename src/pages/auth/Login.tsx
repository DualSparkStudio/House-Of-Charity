    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 transition-colors">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="p-4 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
          <p className="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2 text-center">Demo Accounts</p>
          <div className="grid grid-cols-1 gap-3 text-sm text-gray-600 dark:text-gray-300">
            <div className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md p-3">
              <p className="font-medium text-gray-800 dark:text-gray-200">Donor</p>
              <p>Email: <span className="font-mono">donor@example.com</span></p>
              <p>Password: <span className="font-mono">password123</span></p>
            </div>
            <div className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md p-3">
              <p className="font-medium text-gray-800 dark:text-gray-200">NGO</p>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            ...
            >
              <Users className="h-5 w-5 mr-2 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-400" />
